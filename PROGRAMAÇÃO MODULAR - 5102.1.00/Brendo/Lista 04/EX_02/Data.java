...
public class Data {
    ...
    Format formatter = new SimpleDateFormat("MMMM", br);
    ...
    public String toString() {
        String mes = formatter.format(new Date(getAno(), getMes() -1, getDia()));

        return getDia() + " de " + mes.toLowerCase() + " de " + getAno();
    }

    @Override
    public boolean equals(Object obj) {

        String dia = Integer.toString(getDia());
